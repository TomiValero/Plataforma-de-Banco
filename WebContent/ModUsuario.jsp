...
%>
	...
	<div class="container-md align-items-center">
							<% 
								...
								if(request.getAttribute("FinModificacion") != null){
									FinModificacion = (Boolean) request.getAttribute("FinModificacion"); 
								}							
			...
			<div class="col" style="padding-top:10px">
				<div style="padding: 20px; max-width:; border: 1px solid #ddd; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2); margin: 20px auto;">
				    <h1 class="text-center" style="margin-bottom:20px">Modificar Cliente</h1>
				    <%if(!FinModificacion){%>
				    <form id="formAltaCliente" action="ModUsuarioServlet" method="post">
				    	<div class="row">
				    		<div class="col">
			                    <label for="dni" class="form-label">DNI:</label>
			                    <input type="number" id="txtdni" name="txtdni" required class="form-control mb-2" style="background-color: #f0f0f0;"
			                        value="<%= request.getAttribute("dni") != null ? request.getAttribute("dni") : "" %>" readonly>
			                    
			                    <label for="cuil" class="form-label">CUIL:</label>
			                    <input type="number" id="txtcuil" name="txtcuil" required class="form-control mb-2" style="background-color: #f0f0f0;"
			                        value="<%= request.getAttribute("cuil") != null ? request.getAttribute("cuil") : "" %>" readonly>
					       	...
					       	<div class="col"  style="padding-top:">
			                    ...
			                    <input type="email" id="txtcorreo" name="txtcorreo" required class="form-control mb-2" style="background-color: #f0f0f0;"
			                        value="<%= request.getAttribute("correo") != null ? request.getAttribute("correo") : "" %>" readonly>
			                    ...
			                    <input type="text" id="txtusuario" name="txtusuario" required class="form-control mb-2" style="background-color: #f0f0f0;"
			                        value="<%= request.getAttribute("usuario") != null ? request.getAttribute("usuario") : "" %>" readonly>
			                    
			                    <label for="contrasena" class="form-label">Nueva Contraseña:</label>
			                    <input type="password" id="txtcontrasena" name="txtcontrasena"  class="form-control mb-2" 
			                    ...
			                    <input type="password" id="txtcontrasenaRepetida" name="txtcontrasenaRepetida"  class="form-control mb-2" 
			                        value="<%= request.getAttribute("contrasenaRepetida") != null ? request.getAttribute("contrasenaRepetida") : "" %>">
			               
					        </div>
					        <div class="d-flex justify-content-center">
						        <input type="submit" value="Modificar Cliente" name="btnAceptar" class="btn btn-primary mx-2">	
						    </div>
				        </div>
				    </form>
				    <%} %>
